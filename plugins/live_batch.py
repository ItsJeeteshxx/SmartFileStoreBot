                ...
                if not prog_id:
                    try:
                        ...
                        _prog_txt = (
                            ...
                            f"यह Live Auto-Generator background में काम करता है। यह Live Job से different "
                            f"source channel से target channel में track करता है, फिर उस target channel से "
                            f"इस channel में link बनाकर button देता है (ना कि Admin खुद से कुछ करता है)।\n\n"
                            f"जैसे ही <b>{_thresh} files</b> का threshold पूरा होता है — बोट तुरंत "
                            f"एक Batch Link block (inline buttons के साथ) auto-post कर देता है।\n\n"
