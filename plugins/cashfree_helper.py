...
async def create_cashfree_pass_order(user_id: int, user_name: str, duration: str, amount: float, bot_id: int = None, bot_username: str = "", order_id: str = None, tier: str = "basic", checkout_version: str = "v1") -> dict:
    """
